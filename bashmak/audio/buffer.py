...
кладёт готовый numpy-массив под коротким локом. Обработки в потоке приёма быть
не должно: он общий на весь голосовой клиент, и задержка в нём тормозит приём
речи всех участников сразу.
"""
